        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          >
            <div>
              ...
              >
                Encontre o ritual que acompanha o seu momento
              </p>
            </div>
            <button
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 'clamp(3rem, 6vw, 5rem)' }}>
            ...
            <p style={{
              ...
              Cada encomenda é única e pensada para acompanhar o seu momento de forma sensorial e cuidadosa.
            </p>
          </div>
          ...
          <div style={{
            ...
            <p style={{
              ...
              Todas as velas são produzidas sob encomenda, com ingredientes de origem natural e cuidado em cada etapa do processo. O prazo é confirmado no momento do pedido, de acordo com a disponibilidade.
            </p>
          </div>
        </div>
      </section>
