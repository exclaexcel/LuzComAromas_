    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <svg viewBox="0 0 32 32" fill="none" width="40" height="40" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path d="M16 4 C16 4 14 7 14 9 C14 11.2 14.9 13 16 13 C17.1 13 18 11.2 18 9 C18 7 16 4 16 4Z" fill="#C9A84A" opacity="0.9"/>
            <rect x="13" y="13" width="6" height="14" rx="1" fill="rgba(201,168,74,0.25)" stroke="rgba(201,168,74,0.5)" strokeWidth="0.8"/>
            <line x1="16" y1="13" x2="16" y2="11" stroke="#C9A84A" strokeWidth="1"/>
          </svg>
        </div>
